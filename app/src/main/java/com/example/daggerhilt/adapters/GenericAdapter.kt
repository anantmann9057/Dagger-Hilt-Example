package com.hunger.worries.adapters
...
import com.example.daggerhilt.BR
...
class GenericAdapter @JvmOverloads constructor(
    ...
    fun getmObjects(): ArrayList<Any> {
        return mObjects
    }

    var layoutValue: Int
    private val onItemClickListener: OnItemClickListener<Any>?
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        holder.binding
            .setVariable(BR.model, getItem(position))
        holder.binding.setVariable(
            BR.itemClickListener,
            onItemClickListener
        )
        holder.binding
    ...
    fun addAll(objects: ArrayList<Any>?) {
    ...
    fun insert(objects: ArrayList<Any>?, index: Int) {
        val posStart = mObjects.size
    ...
    fun update(models: ArrayList<Any>, replaceExisting: Boolean) {
...
//        applyAndAnimateRemovals(models);
    ...
    private fun applyAndAnimateRemovals(newModels: ArrayList<Any>) {
    ...
    private fun applyAndAnimateMovedItems(newModels: ArrayList<Any>) {
